...
import com.gxweilan.diniuwang.wechatpay.cert.CertManagerSingleton;
...
public class ScheduledUpdateCertificatesVerifier implements Verifier {
    ...
    public void initCertManager(Credentials credentials, byte[] apiv3Key) {
        ...
        certManagerSingleton.init(credentials, apiv3Key, WeChatPayV3Constants.UPDATE_INTERVAL_MINUTE);
    }
